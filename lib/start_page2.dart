...
class StartPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Think Couriers', style: Theme.of(context).textTheme.title,),
      ),
      body: SafeArea(
        child: Stack(
          children: <Widget>[
...
class StartPageBody2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _StartPageBodyState2();
  }
}

class _StartPageBodyState2 extends State<StartPageBody2> {
  double screenWidth;
  double screenHeight;
                        ...
                        FlatButton(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Text(
                                '\tInstagram',
                                style: TextStyle(color: instaHeighlightedColor),
                              ),
                            ],
                          ),
